...
if __name__ == '__main__':
    with app.app_context():
        ...
        # db.session.commit()
        # acc1 = User(id=p1.id, username="supertien", password=str(hashlib.md5("123".encode("utf-8")).hexdigest()),
        #             user_role=UserRole.ADMIN)
        # acc2 = User(id=p2.id, username="chosh", password=str(hashlib.md5("123".encode("utf-8")).hexdigest()),
        #             user_role=UserRole.STAFF)
        # acc3 = User(id=p3.id, username="mintam", password=str(hashlib.md5("123".encode("utf-8")).hexdigest()),
