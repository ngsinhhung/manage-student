...
if __name__ == '__main__':
    with app.app_context():
        ...
        # new_exam = Exam(student_id=student_id, teach_plan_id=teaching_plan_id)
        #
        # # Thêm điểm cuối kỳ cho đối tượng Exam
        # new_exam.final_points = final_score
        #
        # # Thêm điểm thi 15 phút cho đối tượng Exam
        # for score in score_15p:
        #     new_score = Score(points=score, type=TYPEEXAM.EXAM_15P)
        #     new_exam.scores.append(new_score)
        #
        # # Thêm điểm thi 45 phút cho đối tượng Exam
        # for score in score_45p:
        #     new_score = Score(points=score, type=TYPEEXAM.EXAM_45P)
        #     new_exam.scores.append(new_score)
        #
